...
@Composable
fun SpaghettiPage(nama: String?, lokasi: String?, navController: NavController?) {
    val pesanan: String = stringResource(R.string.value_spagetti)
    Column (
        ...
        Column (
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.spaghetti_desc_lengkap),
