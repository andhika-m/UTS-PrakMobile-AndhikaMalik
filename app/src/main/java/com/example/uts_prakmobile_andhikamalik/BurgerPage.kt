...
@Composable
fun BurgerPage(nama: String?, lokasi: String?, navController: NavController?) {
    val pesanan: String = stringResource(R.string.value_burger)
    Column (
        ...
        Box(
            ...
            Image(painter = painterResource(
                id = R.drawable.__burgerd),
                contentDescription = null
            )
            Text(
                text = stringResource(id = R.string.value_burger),
                color = Color.White,
                fontSize = 24.sp,
        ...
        Column (
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.burger_desc_lengkap),
