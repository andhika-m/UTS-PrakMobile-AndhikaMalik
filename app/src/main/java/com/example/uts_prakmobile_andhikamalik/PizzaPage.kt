...
@Composable
fun PizzaPage(nama: String?, lokasi: String?, navController: NavController?) {
    val pesanan: String = stringResource(R.string.value_pizza)
    Column (
        ...
        Box(
            ...
            Image(painter = painterResource(
                id = R.drawable.pepperoni_pizza_1),
        ...
        Column (
            ...
            Row(
                ...
                Text(
                    text = stringResource(id = R.string.pizza_desc_lengkap),
